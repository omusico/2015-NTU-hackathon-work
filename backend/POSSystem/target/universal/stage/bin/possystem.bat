@REM possystem launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM POSSYSTEM_config.txt found in the POSSYSTEM_HOME.
@setlocal enabledelayedexpansion

@echo off
if "%POSSYSTEM_HOME%"=="" set "POSSYSTEM_HOME=%~dp0\\.."
set ERROR_CODE=0

set "APP_LIB_DIR=%POSSYSTEM_HOME%\lib\"
...
set "CFG_FILE=%POSSYSTEM_HOME%\POSSYSTEM_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running possystem.
  echo.
